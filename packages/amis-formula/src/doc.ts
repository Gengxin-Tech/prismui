...
bulkRegisterFunctionDoc([
  ...
  {
    name: "MERGE",
    description: "合并多个对象，后者的属性覆盖前者（浅合并）。\n\n示例：\n\nMERGE({a: 1}, {b: 2}, {a: 3}) 得到 {a: 3, b: 2}。",
  ...
  {
    name: "FROMTUPLE",
    description: "从键值对数组创建对象，将二维数组转换为对象形式。\n\n示例：\n\nFROMTUPLE([['a', 1], ['b', 2]]) 得到 {a: 1, b: 2}。",
