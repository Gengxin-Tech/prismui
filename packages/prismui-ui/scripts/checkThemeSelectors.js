...
const scans = [
  {
    ...
    paths: [
      'packages/prismui-ui/scss',
      'packages/prismui-theme-editor-helper/src',
      'packages/prismui-editor-core/scss',
      'packages/prismui-editor/examples',
      'examples'
    ],
  ...
  },
  {
    ...
    paths: [
      'packages/prismui-core/src',
      'packages/prismui-framework/src',
      'packages/prismui-ui/src',
      'packages/prismui-editor-core/src',
      'packages/prismui-theme-editor-helper/src'
    ],
    extensions: ['.ts', '.tsx'],
    regex:
...
function classifyMatch(scan, file, line) {
  ...
  if (scan.id === 'direct-portal-theme-scope') {
    return normalizedFile.endsWith(
      'packages/prismui-ui/src/components/MobileDevTool.tsx'
    )
      ? 'theme-scope-portal-exception'
      : 'theme-scope-portal-covered';
  }
  ...
  if (
    normalizedFile.startsWith('packages/prismui-theme-editor-helper/') ||
    normalizedFile.startsWith('packages/prismui-editor-core/')
  ) {
...
function fixtureScans(name) {
  const fixtureRoot = `packages/prismui-ui/scripts/theme-selectors/fixtures/${name}`;
