...
- `.codestable/roadmap/theme-system-refactor/goal-plan.md`
...
- `.codestable/roadmap/theme-system-refactor/goal-features/*.md`
- `.codestable/roadmap/theme-system-refactor/goal-protocol-feature-loop.md`
- `.codestable/roadmap/theme-system-refactor/goal-protocol-gates.md`
- `.codestable/roadmap/theme-system-refactor/goal-protocol-audit.md`
...
- `commit_authorization: approved` 也须独立指向同 roadmap 的 `approval-report.md#goal-commits` 且命名决策为 approved；acceptance ref 不可复用。缺失或拒绝时不得启动、继续或提交。
- 运行 `python3 <cs-onboard skill 目录>/tools/codestable-workflow-next.py epic --roadmap .codestable/roadmap/theme-system-refactor --json`；只有 `dispatch_goal` / `awaiting` 且 evidence 同时返回两份预期 ref 才可启动或继续 driver。
...
Plan: .codestable/roadmap/theme-system-refactor/goal-plan.md
Protocol: .codestable/roadmap/theme-system-refactor/goal-protocol.md
```
