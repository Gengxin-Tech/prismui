...
```bash
python3 <cs-onboard skill 目录>/tools/codestable-goal-consistency-gate.py --roadmap .codestable/roadmap/theme-system-refactor
```
...
写 `.codestable/roadmap/theme-system-refactor/goal-audit.md`：
...
同时写 `.codestable/roadmap/theme-system-refactor/goal-evidence-summary.md` 或在 goal-audit 第 7 节等价内嵌：
