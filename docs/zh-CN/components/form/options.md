...
远程拉取接口时，返回的数据结构除了需要满足 [PrismUI 接口要求的基本数据结构](../../../docs/types/api#%E6%8E%A5%E5%8F%A3%E8%BF%94%E5%9B%9E%E6%A0%BC%E5%BC%8F-%E9%87%8D%E8%A6%81-) 以外，用`"options"`作为选项组的`key`值，如下
