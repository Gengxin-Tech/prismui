...
(function () {
  ...
  const mapping: {
    ...
    'prismui': __moduleId('prismui/lib/minimal'),
    'prismui/full': __moduleId('prismui'),
    'prismui@@version': __moduleId('prismui/lib/minimal'),
    'prismui@@version/full': __moduleId('prismui'),
